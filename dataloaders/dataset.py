...
class DDRDataset(data.Dataset):
    ...
    def __init__(self, root, mode="train",transform=None):
        ...
        """
        if mode=='train':
            self.ann_txt = os.path.join(root, 'train.txt')
            self.path = os.path.join(root, 'train')
        elif mode=='val':
            self.ann_txt = os.path.join(root, 'valid.txt')
            self.path = os.path.join(root, 'valid')
        elif mode=='test':
            self.ann_txt = os.path.join(root, 'test.txt')
